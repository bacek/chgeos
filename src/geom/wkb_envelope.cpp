...
class WKBCursor {
    ...
    void expand_coord_seq(BBox & env, uint32_t num_points, uint32_t coord_dims) {
    ...
    void skip_coord_seq(uint32_t num_points, uint32_t coord_dims) {
