...
// ── Buffers — predicates ──────────────────────────────────────────────────────
CH_UDF_BUFFERS_BBOX2_POINT(st_contains,   bbox_op_contains,   false)
CH_UDF_BUFFERS_BBOX2_POINT(st_intersects, bbox_op_intersects, false)
CH_UDF_BUFFERS_BBOX2(st_touches,          bbox_op_intersects, false)
CH_UDF_BUFFERS_BBOX2_POINT(st_within,    bbox_op_rcontains,  false)
CH_UDF_BUFFERS_BBOX2(st_crosses,          bbox_op_intersects, false)
CH_UDF_BUFFERS_BBOX2(st_overlaps,         bbox_op_intersects, false)
CH_UDF_BUFFERS_BBOX2(st_disjoint,         bbox_op_intersects, true)
CH_UDF_BUFFERS_BBOX2(st_equals,           bbox_op_intersects, false)
CH_UDF_BUFFERS_BBOX2_POINT(st_covers,    bbox_op_contains,   false)
CH_UDF_BUFFERS_BBOX2_POINT(st_coveredby, bbox_op_rcontains,  false)
CH_UDF_BUFFERS_BBOX2(st_containsproperly,bbox_op_contains,   false)
CH_UDF_BUFFERS_PRED3(st_dwithin)

// ── Buffers — scalar and geometry functions ───────────────────────────────────
CH_UDF_BUFFERS(st_x)
CH_UDF_BUFFERS(st_y)
CH_UDF_BUFFERS(st_z)
...
CH_UDF_BUFFERS(st_node)
CH_UDF_BUFFERS(st_linmerge)
CH_UDF_BUFFERS(st_polygonize)
CH_UDF_BUFFERS(st_clusterintersecting)
CH_UDF_BUFFERS(st_extent)
CH_UDF_BUFFERS(st_interiorpoint)
CH_UDF_BUFFERS(st_expand)

// ── Buffers — additional functions ────────────────────────────────────────────
CH_UDF_BUFFERS(st_hausdorffdistance_densify)
CH_UDF_BUFFERS(st_frechetdistance_densify)
CH_UDF_BUFFERS(st_relate_pattern)
CH_UDF_BUFFERS(geos_version)
CH_UDF_BUFFERS(st_geomfromgeojson)
CH_UDF_BUFFERS(st_startpoint)
CH_UDF_BUFFERS(st_endpoint)
CH_UDF_BUFFERS(st_makebox2d)
CH_UDF_BUFFERS(st_geometryn)
CH_UDF_BUFFERS(st_exteriorring)
CH_UDF_BUFFERS(st_interiorringn)
CH_UDF_BUFFERS(st_pointn)
CH_UDF_BUFFERS(st_minimumboundingcircle)
CH_UDF_BUFFERS(st_snap)
CH_UDF_BUFFERS(st_offsetcurve)
CH_UDF_BUFFERS(st_delaunaytriangles)
CH_UDF_BUFFERS(st_voronoidiagram)
CH_UDF_BUFFERS(st_makepoint)
CH_UDF_BUFFERS(st_makepoint3d)
CH_UDF_BUFFERS(st_makepolygon)
CH_UDF_BUFFERS(st_addpoint)
CH_UDF_BUFFERS(st_removepoint)
CH_UDF_BUFFERS(st_setpoint)
CH_UDF_BUFFERS(st_buffer)
CH_UDF_BUFFERS(st_buffer_params)
CH_UDF_BUFFERS(st_simplify)
CH_UDF_BUFFERS(st_segmentize)
CH_UDF_BUFFERS(st_subdivide)
CH_UDF_BUFFERS(st_translate)
CH_UDF_BUFFERS(st_scale)
CH_UDF_BUFFERS(st_setsrid)
CH_UDF_BUFFERS(st_transform)
CH_UDF_BUFFERS(st_transform_proj)
