...
CH_UDF_COL_GEOM2(st_symdifference)
CH_UDF_COL_GEOM2(st_collect)
CH_UDF_COL_GEOM2(st_closestpoint)
CH_UDF_COL_GEOM2(st_shortestline)
CH_UDF_COL_GEOM2(st_sharedpaths)
...
CH_UDF_COL_GEOM1(st_reverse)
CH_UDF_COL_GEOM1(st_normalize)
CH_UDF_COL_GEOM1(st_node)
CH_UDF_COL_GEOM1(st_linmerge)
CH_UDF_COL_GEOM1(st_polygonize)
CH_UDF_COL_GEOM1(st_clusterintersecting)
CH_UDF_COL_GEOM1(st_extent)
CH_UDF_COL_GEOM1(st_interiorpoint)
