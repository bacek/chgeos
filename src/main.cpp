...
// ── ColumnBinary — predicates ─────────────────────────────────────────────────
CH_UDF_CB_BBOX2_POINT(st_contains,   bbox_op_contains,   false)
CH_UDF_CB_BBOX2_POINT(st_intersects, bbox_op_intersects, false)
CH_UDF_CB_BBOX2(st_touches,          bbox_op_intersects, false)
CH_UDF_CB_BBOX2_POINT(st_within,    bbox_op_rcontains,  false)
CH_UDF_CB_BBOX2(st_crosses,          bbox_op_intersects, false)
CH_UDF_CB_BBOX2(st_overlaps,         bbox_op_intersects, false)
CH_UDF_CB_BBOX2(st_disjoint,         bbox_op_intersects, true)
CH_UDF_CB_BBOX2(st_equals,           bbox_op_intersects, false)
CH_UDF_CB_BBOX2_POINT(st_covers,    bbox_op_contains,   false)
CH_UDF_CB_BBOX2_POINT(st_coveredby, bbox_op_rcontains,  false)
CH_UDF_CB_BBOX2(st_containsproperly,bbox_op_contains,   false)
...
CH_UDF_CB(st_area)
CH_UDF_CB(st_length)
CH_UDF_CB(st_perimeter)
CH_UDF_CB(st_distance)
CH_UDF_CB(st_hausdorffdistance)
CH_UDF_CB(st_frechetdistance)
CH_UDF_CB(st_isvalid)
CH_UDF_CB(st_isempty)
CH_UDF_CB(st_issimple)
CH_UDF_CB(st_isring)
CH_UDF_CB(st_srid)
CH_UDF_CB(st_npoints)
CH_UDF_CB(st_numpoints)
CH_UDF_CB(st_numgeometries)
CH_UDF_CB(st_numinteriorrings)
CH_UDF_CB(st_nrings)
CH_UDF_CB(st_dimension)
CH_UDF_CB(st_astext)
CH_UDF_CB(st_asewkt)
CH_UDF_CB(st_geometrytype)
CH_UDF_CB(st_isvalidreason)
CH_UDF_CB(st_relate)
CH_UDF_CB(st_intersection)
CH_UDF_CB(st_union)
CH_UDF_CB(st_difference)
CH_UDF_CB(st_makeline)
CH_UDF_CB(st_symdifference)
CH_UDF_CB(st_collect)
CH_UDF_CB(st_closestpoint)
CH_UDF_CB(st_shortestline)
CH_UDF_CB(st_sharedpaths)
CH_UDF_CB(st_convexhull)
CH_UDF_CB(st_envelope)
CH_UDF_CB(st_centroid)
CH_UDF_CB(st_makevalid)
CH_UDF_CB(st_boundary)
CH_UDF_CB(st_unaryunion)
CH_UDF_CB(st_reverse)
CH_UDF_CB(st_normalize)
CH_UDF_CB(st_node)
CH_UDF_CB(st_linmerge)
CH_UDF_CB(st_polygonize)
CH_UDF_CB(st_clusterintersecting)
CH_UDF_CB(st_extent)
CH_UDF_CB(st_interiorpoint)
CH_UDF_CB(st_expand)

// ── ColumnBinary — additional functions ───────────────────────────────────────
CH_UDF_CB(st_hausdorffdistance_densify)
CH_UDF_CB(st_frechetdistance_densify)
CH_UDF_CB(st_relate_pattern)
CH_UDF_CB(geos_version)
CH_UDF_CB(st_geomfromgeojson)
CH_UDF_CB(st_startpoint)
CH_UDF_CB(st_endpoint)
CH_UDF_CB(st_makebox2d)
CH_UDF_CB(st_geometryn)
CH_UDF_CB(st_exteriorring)
CH_UDF_CB(st_interiorringn)
CH_UDF_CB(st_pointn)
CH_UDF_CB(st_minimumboundingcircle)
CH_UDF_CB(st_snap)
CH_UDF_CB(st_offsetcurve)
CH_UDF_CB(st_delaunaytriangles)
CH_UDF_CB(st_voronoidiagram)
CH_UDF_CB(st_makepoint)
CH_UDF_CB(st_makepoint3d)
CH_UDF_CB(st_makepolygon)
CH_UDF_CB(st_addpoint)
CH_UDF_CB(st_removepoint)
CH_UDF_CB(st_setpoint)
CH_UDF_CB(st_buffer)
CH_UDF_CB(st_buffer_params)
CH_UDF_CB(st_simplify)
CH_UDF_CB(st_segmentize)
CH_UDF_CB(st_subdivide)
CH_UDF_CB(st_translate)
CH_UDF_CB(st_scale)
CH_UDF_CB(st_setsrid)
